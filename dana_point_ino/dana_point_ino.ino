...
void setup() {
  ...
  double surface_waypoints [] = { 0,5,0,0 };   // listed as x0,y0,x1,y1, ... etc.
...
void loop() {
  ...
  // if (currentTime > 20000 && currentTime < 27000) {
    //motor_driver.drive(219, 255, 0);  //  Left Motor, right, 

  //} 
  //else if (currentTime>28000 && currentTime < 35000) {
  //  motor_driver.drive(-244, -255, 0);
  //}

  if (currentTime>20000 && currentTime < 27000) {
    motor_driver.drive(180, 205, 0);
  }
  else if (currentTime>28000 && currentTime < 35000) {
    motor_driver.drive(-197, -215, 0);

  }

 // else if (currentTime>54000 && currentTime < 63000) {
 //   motor_driver.drive(143, 150, 0);
//  }

  //else if (currentTime>64000 && currentTime < 73000) {
    //motor_driver.drive(-140, -150, 0);
  //}

  //else if (currentTime>74000 && currentTime < 84000) {
    //motor_driver.drive(93, 105, 0);
  //}

  //else if (currentTime>85000 && currentTime < 95000) {
    //motor_driver.drive(-93, -100, 0);
  //}
